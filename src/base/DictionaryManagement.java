...
public class DictionaryManagement extends Dictionary {
    ...
    public static void addWord(String searching, String meaning) {
        ...
        if (posAddWord == -1) {
            System.out.println("The word you are trying to add already exists. Please choose the modify function!");
            return;
        }
    ...
    public static void removeWordFromCommandLine() {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void removeWord(String searching) {
        ...
        if (index >= 0) {
            ...
            System.out.println("The word you want to remove is not in the dictionary!");
        }
        updateWordToFile();
    }

    public static void modifyWordFromCommandLine() {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void modifyWord(String searching, String meaning) {
        ...
        if (pos >= 0) {
            ...
            System.out.println("The word you want to modify is not found!");
        }
        updateWordToFile();
    }
